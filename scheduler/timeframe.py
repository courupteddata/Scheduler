...
class TimeFrame:
    def __init__(self, begin: datetime = None, end: datetime = None, inclusive: bool = True):
        """
    ...
    def __contains__(self, item) -> bool:
        ...
        if item is None:  # Ignore None values items
            return False
        if item is datetime:  # Now to check to see if the item will be contained in the specified date range
            if self.inclusive:
